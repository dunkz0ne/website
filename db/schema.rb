...
ActiveRecord::Schema.define(version: 2024_09_16_155902) do
  ...
  add_foreign_key "articles", "users", on_delete: :nullify
  add_foreign_key "banned_users", "users", column: "admin_id", on_delete: :nullify
  ...
  add_foreign_key "releases", "users", on_delete: :nullify
